...
/**
 * EventCreateRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Admin\Client
 * @author   OpenAPI Generator team
 ...
 */
class EventCreateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EventCreateRequest';
    ...
    */
    ...
    public function setTitle($title)
    {
        ...
        if ((mb_strlen($title) < 1)) {
            throw new \InvalidArgumentException('invalid length for $title when calling EventCreateRequest., must be bigger than or equal to 1.');
        }
