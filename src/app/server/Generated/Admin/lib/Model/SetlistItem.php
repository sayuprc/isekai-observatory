...
/**
 * SetlistItem Class Doc Comment
 *
 * @category Class
 * @description セットリストの 1 項目
 * @package  OpenAPI\Admin\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class SetlistItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SetlistItem';
    ...
    */
    ...
    public function setOrderNo($order_no)
    {
        ...
        if (($order_no < 1)) {
            throw new \InvalidArgumentException('invalid value for $order_no when calling SetlistItem., must be bigger than or equal to 1.');
        }
