...
readonly class UpdateInputData
{
     ...
     * @param list<array{performanceId: string, songId: string, orderNo: int, coVocalists: list<array{personId: string, name: string, creditName: ?string, orderNo: int}>}> $performances
