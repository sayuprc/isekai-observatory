  ...
  <>
    <fieldset class="fieldset bg-base-200 border-base-300 rounded-box border p-6">
      ...
      <div class="grid gap-4 md:grid-cols-2">
        <div>
          <label class="label" for="typeValue">
            種別
          </label>
          <select
            id="typeValue"
        ...
        <div>
          <label class="label" for="statusValue">
            状態
          </label>
          <select
            id="statusValue"
      ...
      <div class="grid gap-4 md:grid-cols-2">
        <div>
          <label class="label" for="isDisplay">
            表示設定
          </label>
          <select
            id="isDisplay"
